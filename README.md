# About Me:
Hey guys, my name is Cris Huynh<br><br>I'm currently studying BSD (Honours Bachelor of Technology - Software Development)<br>-----------------------------------<br>Learning Machine Learning, Full Stack Developer and Software Developer (Currently Software Developer using Python, Java, JS, TypeScript, C++ and C#)<br><br>🖥️4th Year (7th semester) Software Developing Student<br><br>2026 Goals: Amazonnnnnnnnnn
