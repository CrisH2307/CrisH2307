# 💫 About Me:
Hey guys, my name is Cris Huynh<br><br>I'm currently studying BSD (Honours Bachelor of Technology - Software Development)<br>-----------------------------------<br>👨‍💻 Learning Full Stack Developer (Currently Frontend Developer using React, JS, TypeScript, MongoDB, Next.js and HTML)<br><br>🖥️ 2nd Year (4th semester) Software Developing Student<br><br>🥅 2024 Goals: Next.js, DSA and Algorithm and Learning Full Stack
